...
public class AddDownloadFromUrlDialog extends ADialog implements DownloadDialog {
    ...
    private void jbtn_downloadLaterActionPerformed(ActionEvent e) {
        ...
        try {
            ...
            this.download = new BaseDownload(name, url, category.getOutputDir(), "mp4", authData, category, 0);
            this.download.setFormatter(new BaseDownloadFormatter(this.download));
    ...
    private void jbtn_downloadNowActionPerformed(ActionEvent e) {
        ...
        try {
            ...
            this.download = new BaseDownload(name, url, category.getOutputDir(), "mp4", authData, category, 0);
            download.setFormatter(new BaseDownloadFormatter(download));
