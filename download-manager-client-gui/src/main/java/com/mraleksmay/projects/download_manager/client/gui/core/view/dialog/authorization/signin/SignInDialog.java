...
package com.mraleksmay.projects.download_manager.client.gui.core.view.dialog.authorization.signin;
...
public class SignInDialog extends ADialog {
    ...
    private void jbtn_loginActionPerformed(ActionEvent e) {
        ...
        try {
            final String token = getApplicationManager().getClientManager().signIn(login, password);
