package com.mraleksmay.projects.download_manager.client.gui.platform.subsystem.downloads;
...
public class Scheduler {
    ...
    private synchronized List<DownloadEntityInformation> getDownloadsList() {
        ...
        // Remove completed downloads from schedule.
        downloadsList = downloadsList.stream()
                .filter(de -> !de.getDownload().isCompleted())
