...
package com.mraleksmay.projects.download_manager.client.gui.platform.view.dialog.authorization.signup;
...
public class SignUpDialog extends ADialog {
    ...
    private void jbtn_loginActionPerformed(ActionEvent e) {
        ...
        try {
            final String token = RESTClient.UserService.signUp(login, password);
